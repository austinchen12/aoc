...
for line in data:
    ...
    for _ in range(steps):
        ...
        if dist_squared == 0 or dist_squared == 1 or dist_squared == 2:
            pass
        elif dist_squared == 4:
            tail = ((head[0] + tail[0]) // 2, (head[1] + tail[1]) // 2)
        elif dist_squared == 5:
            if (head[0] - tail[0]) % 2 == 0:
                tail = ((head[0] + tail[0]) // 2, head[1])
            elif (head[1] - tail[1]) % 2 == 0:
...
for line in data:
    ...
    for _ in range(steps):
        ...
        for i in range(9):
            ...
            if dist_squared == 0 or dist_squared == 1 or dist_squared == 2:
                pass
            elif (head[0] - tail[0]) % 2 == 0 and (head[1] - tail[1]) % 2 == 0:
                tail = ((head[0] + tail[0]) // 2, (head[1] + tail[1]) // 2)
            elif dist_squared == 5:
                if (head[0] - tail[0]) % 2 == 0:
                    tail = ((head[0] + tail[0]) // 2, head[1])
                ...
                print('uhh', dist_squared, i, parts, head, tail)
                assert False
            parts[i + 1] = tail
            # print(i + 1, tail)
